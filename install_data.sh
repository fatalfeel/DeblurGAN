...
for i in `seq 1130 1139`; do mv ./data/blurred/train/$i.png ./data/blurred/val; done
for i in `seq 1140 1151`; do mv ./data/blurred/train/$i.png ./data/blurred/test; done
for i in `seq 1130 1139`; do mv ./data/sharp/train/$i.png ./data/sharp/val; done
for i in `seq 1140 1151`; do mv ./data/sharp/train/$i.png ./data/sharp/test; done
