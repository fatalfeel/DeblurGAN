...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--n_layers_G', type=int, default=2, help='2 layers features 2^6~2^8, 3 layers features 2^6~2^9')
        self.parser.add_argument('--n_blocks_G', type=int, default=9, help='ResnetBlocks at 6, 9, 12...')
        ...
        self.parser.add_argument('--content_weight', type=float, default=20.0, help='fast-neural-style content weight')
